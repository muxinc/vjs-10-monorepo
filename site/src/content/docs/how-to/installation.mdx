...
Welcome to Video.js v10! This guide will help you get up and running. You'll make three key choices:
...
Learn more about skins in the <DocsLink slug="concepts/skins">Skins concept guide</DocsLink>.

Currently, Video.js v10 uses CSS for styling these skins. More styling approaches (e.g, Tailwind) are coming soon.
