...
Video.js v10 components are built from **unstyled UI primitives**, taking inspiration from projects like [shadcn/ui](https://ui.shadcn.com/) and [Base UI](https://base-ui.com/). This approach gives you complete control over styling and behavior while handling the complex interactions for you.
...
Ready to dive in? <DocsLink slug="reference/play-button">Browse all component documentation →</DocsLink>