...
Skins are designed to be copied and modified for your specific needs. The copy-paste approach (similar to shadcn/ui) gives you complete control.

Ready to make it your own? <DocsLink slug="how-to/customize-the-skin">Learn how to customize a skin →</DocsLink>
