...
description: Video.js 6.5.0 introduces <video-js> element for simpler embedding without requiring <video> tag, implements smooth progress bar animation, fixes major memory leaks with retained DOM elements, and restricts seek/playback toggling to left-click only.
...
![before the change](../../assets/blog/2017-11-27-video-js-6-5-0-release/before.gif)
![after the change](../../assets/blog/2017-11-27-video-js-6-5-0-release/after.gif)
