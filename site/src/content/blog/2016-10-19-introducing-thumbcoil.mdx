...
description: Thumbcoil debuts as an open-source suite of tools for inspecting H.264 video bitstreams within MP4 and MPEG2-TS containers, using parser combinators to decode NAL units, parameter sets, and slice headers for debugging Mux.js transmuxer output.
tags:
  - thumbcoil
  - mse
  - hls
authors: [jon-carlos-rivera]
---
