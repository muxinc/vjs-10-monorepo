...
description: Video.js 8 and VHS 3 drop IE support and ES5 transpilation for 3-4% size reduction, introduce new TitleBar component with loadMedia metadata support, reorganize utilities into videojs.dom/fn/num/obj/str/time/url objects, and target evergreen browsers plus Chromium 53 for Smart TV compatibility.
authors: [pat-oneill]
---
...
<Aside type="note">
For details on migrating from Video.js 7.x to 8.x, please see [our migration guide](/guides/videojs-7-to-8/)!
</Aside>
