---
title: Video.js 7.4
description: Video.js 7.4 debuts experimental live UI enabling seekable live streams with time display relative to live point, adds 14 first-time contributors, removes Grunt for npm scripts, updates focus-visible menu backgrounds, implements replay option, and expands to six new translations.
tags:
  - a11y
  - responsive
  - languages
...
![Video.js, with the new Live UI, playing a live stream](../../assets/blog/2019-01-11-video-js-7-4/live-ui.png)
