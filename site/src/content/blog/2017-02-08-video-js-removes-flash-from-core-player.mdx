...
description: Video.js 6.0 removes Flash from core player following Chrome, Safari, and Firefox's deprecation steps, moving it to separate videojs-flash plugin to reduce legacy code and minimize player footprint while maintaining backwards compatibility.
tags:
  - video.js 6.0
  - flash
  - html5
authors: [michael-roca]
---
