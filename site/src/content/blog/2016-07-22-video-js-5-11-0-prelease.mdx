...
description: Video.js 5.11.0 pre-release un-deprecates videojs.players property, enables waiting for source before playback, improves caption settings accessibility, but includes known MPEG-DASH compatibility issues requiring investigation.
tags:
  - news
  - releases
  - version
