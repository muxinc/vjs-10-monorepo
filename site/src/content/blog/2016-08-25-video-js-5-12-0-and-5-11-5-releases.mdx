...
description: Video.js releases 5.11.5 stable and 5.12.0 pre-release with comprehensive codebase linting, ES5 source file exposure for webpack/browserify bundling, Node.js requiring support, and preparation for automated changelog generation with standard-version.
tags:
  - news
  - releases
  - version
