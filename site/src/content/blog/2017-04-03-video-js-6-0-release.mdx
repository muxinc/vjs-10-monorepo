...
description: Video.js 6.0 officially releases with enhanced accessibility for controls and components, Flash removal from core, middleware for tech-player communication, advanced plugins with React-inspired architecture, asynchronous source selection, and Code of Conduct adoption.
tags:
  - middleware
  - video.js 6.0
  - accessibility
