...
description: VHS 1.2.0 introduces built-in CEA-608 caption parsing from FMP4 segments for HLS and MPEG-DASH using mux.js CaptionParser, automatically extracting caption streams and converting to VTTCue format for Video.js TextTrack API integration.
tags:
  - vhs
...
<MinimalFrame class="aspect-video">
  <iframe class="absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/0yTYNIajBQM" frameBorder="0" allowFullScreen />
</MinimalFrame>
