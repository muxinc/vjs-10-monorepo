...
description: Video.js officially adopts videojs-vr as first-class plugin with Video.js 6 support, using three.js canvas with webvr-polyfill for 360/VR playback across equirectangular and cube projections, supporting VIVE, Oculus, and Google Cardboard.
tags:
  - vr
  - "360"
  - plugins
