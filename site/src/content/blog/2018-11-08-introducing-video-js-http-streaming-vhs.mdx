...
description: Video.js HTTP Streaming (VHS) debuts as successor to videojs-contrib-hls, adding DASH support with shared codebase, bundled by default in Video.js 7 for cross-browser HLS and DASH playback without external plugins, with opt-out via core build.
tags:
  - vhs
  - videojs-http-streaming
  - http-streaming
  - playback
authors: [garrett-singer]
---
...
![VHS logo](../../assets/blog/2018-11-08-introducing-video-js-http-streaming-vhs/vhs-logo.svg)
