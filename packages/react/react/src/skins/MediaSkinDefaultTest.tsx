import cssModules from './styles-test.module.css';
...
import styles from './styles-test-file';

export const MediaSkinDefaultTest: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  return (
