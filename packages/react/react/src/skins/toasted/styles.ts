...
const styles: MediaToastedSkinStyles = {
  MediaContainer: cn(
    ...
    // Base typography
    'font-[420] font-sans text-[0.8125rem] @7xl/root:text-[0.9375rem] leading-normal tracking-[-0.0125em]',
  ...
  Controls: cn(
    'controls', // FIXME: Temporary className hook for above logic. Can be removed once have a proper selector as above.
