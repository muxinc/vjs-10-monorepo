...
describe('import Transformation', () => {
  ...
  describe('@videojs/react component imports', () => {
    it('transforms single component import', () => {
      ...
      const result = compile(source);
      expect(result.imports).toContain(`import '@videojs/html/define/media-play-button';`);
    });
    ...
    it('transforms multiple component imports', () => {
      ...
      const result = compile(source);
      expect(result.imports).toContain(`import '@videojs/html/define/media-play-button';`);
      expect(result.imports).toContain(`import '@videojs/html/define/media-mute-button';`);
      expect(result.imports).toContain(`import '@videojs/html/define/media-time-slider';`);
    });
    ...
    it('transforms MediaContainer correctly', () => {
      ...
      const result = compile(source);
      expect(result.imports).toContain(`import '@videojs/html/define/media-container';`);
    });
  });
  ...
  describe('@videojs/react/icons imports', () => {
    it('transforms icon imports to single icons import', () => {
      ...
      const result = compile(source);
      expect(result.imports).toContain(`import '@videojs/html/icons';`);
    });
  });
  ...
  describe('complete example', () => {
    it('transforms all imports in realistic component', () => {
      ...
      expect(result.imports.join('')).not.toContain('react');
    });
  });
});
