/**
 * Frosted Skin Test Fixture
 *
 * Direct copy from packages/react/src/skins/frosted/FrostedSkin.tsx
 * Uses actual imports and structure from production code
 */
...
import styles from '../../../react/src/skins/frosted/styles';
