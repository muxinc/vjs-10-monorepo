...
describe('jSX Transformation', () => {
  describe('element Name Transformation', () => {
    ...
    it('preserves built-in elements unchanged', () => {
      ...
      const result = compile(source);
      expect(result.html).toBe('<div><button><span>Text</span></button></div>');
    });
  });
  ...
  describe('attribute Transformation', () => {
    ...
    it('handles boolean attribute values', () => {
      ...
      const result = compile(source);
      expect(result.html).toBe('<button disabled="true"></button>');
    });
  ...
  describe('children Transformation', () => {
    it('transforms {children} to slot element', () => {
      ...
      const result = compile(source);
      expect(result.html).toBe('<div><slot name="media" slot="media"></slot></div>');
    });
    ...
    it('handles nested elements', () => {
      ...
      const result = compile(source);
      expect(result.html).toBe(
        '<div><button><span>Icon</span><span>Text</span></button></div>',
      );
    });
  });
  ...
  describe('cSS Generation', () => {
    it('generates placeholder CSS for extracted classNames', () => {
      const source = `
        export default function TestSkin() {
    ...
    it('sorts classNames alphabetically in CSS', () => {
      const source = `
        export default function TestSkin() {
          return (
            <div>
    ...
    it('handles empty classNames gracefully', () => {
      const source = `
        export default function TestSkin() {
