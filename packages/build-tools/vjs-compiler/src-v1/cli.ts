...
import { getAvailablePipelines, getPipeline } from './pipelines/index.js';
...
function printUsage() {
  ...
  console.error(
    '  vjs-compiler compile src/MediaSkin.tsx --type skin --format web-component --css inline --out-dir dist'
  );
