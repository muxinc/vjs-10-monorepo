 ...
 */
export function extractDeclarationsForSelector(root: Root, selector: string): Map<string, string> {
  const declarations = new Map<string, string>();
...
export function compareDeclarations(expected: Map<string, string>, actual: Map<string, string>): CSSDeclarationDiff[] {
